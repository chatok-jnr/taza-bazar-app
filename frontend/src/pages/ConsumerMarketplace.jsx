...
export default function MarketplacePage() {
  ...
  const response = await fetch('https://taza-bazar-backend.onrender.com/api/v1/farmer', {
        method: 'GET',
        headers: {
  ...
  const response = await fetch(`https://taza-bazar-backend.onrender.com/api/v1/buyer/consumer/${user.user_id}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const response = await fetch('https://taza-bazar-backend.onrender.com/api/v1/buyer/accepted', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const response = await fetch('https://taza-bazar-backend.onrender.com/api/v1/buyer', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
