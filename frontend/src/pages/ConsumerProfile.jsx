...
export default function ConsumerProfile() {
  ...
  const response = await fetch(`https://taza-bazar-backend.onrender.com/api/v1/users/${user.user_id}`, {
          method: 'GET',
          headers: {
              ...
              <div className="bg-white rounded-xl shadow-sm border border-green-100 p-6 transition-all duration-300 hover:shadow-md hover:border-green-200">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-800 font-semibold mt-1">৳{profile.total_spent || '0'}</p>
                  </div>
                </div>
              </div>
