...
export default function LoginPage() {
  ...
  const handleLogin = (role) => {
    ...
    login(role); // Set the user role in the global context
    if (role === 'consumer') {
      navigate('/consumer');
    } else {
      navigate('/farmer');
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col space-y-3 pt-4">
              <button
                ...
                className="w-full py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-all duration-300 transform hover:scale-105"
              >
                Log In as Consumer
              </button>
              <button
                onClick={() => handleLogin('farmer')}
                className="w-full py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-all duration-300 transform hover:scale-105"
              >
                Log In as Farmer
              </button>
            </div>
