...
export default function ConsumerDashboard() {
  ...
  const confirmDeleteRequest = async () => {
    ...
    try {
      ...
      const response = await fetch(
        getApiUrl(`api/v1/consumer/${requestToDelete}`),
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
            ...
            <div className="space-y-6">
              {Array.isArray(requests) && requests.length > 0 ? (
                requests.map((requestItem) => (
                  <div
                    key={requestItem._id || requestItem.id}
                            ...
                            <div className="flex items-center space-x-2 text-gray-700">
                              ...
                              <div>
                                ...
                                <p className="font-semibold">
                                  {requestItem.product_quantity}{" "}
                                  {requestItem.quantity_unit}
                                </p>
                              </div>
                            </div>
                            <div className="flex items-center space-x-2 text-gray-700">
                            ...
                            <div className="flex items-center space-x-2 text-gray-700">
                              ...
                              <div>
                                ...
                                <p className="font-semibold text-sm">
                                  {requestItem.request_description ||
                                    "No description"}
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="space-y-2 mb-4">
                          ...
                          {product.from && product.to && (
                            <div className="flex items-center text-gray-700">
                              ...
                              <span className="text-sm">
                                Available:{" "}
                                {new Date(product.from).toLocaleDateString()} -{" "}
                                {new Date(product.to).toLocaleDateString()}
                              </span>
                            </div>
                          )}
                          ...
                          {product.product_description && (
                            <div className="flex items-start text-gray-700">
                              <FileText
                                size={16}
                                className="mr-2 text-green-600 mt-0.5"
                              />
                              <span className="text-sm">
                                {product.product_description}
                              </span>
      ...
      case "Messages":
        return (
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Chat with farmers and other consumers
            </p>
            <div className="text-center py-16">
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-6">
                Are you sure you want to delete this request? This will
                permanently remove the request and cannot be undone.
              </p>
