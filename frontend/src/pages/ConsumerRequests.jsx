      ...
      const mockRequests = [
        {
          ...
          budget: "200",
          location: "Dhaka",
          description: "Need fresh organic tomatoes for restaurant",
          ...
          bids: [
            {
              ...
              price: "180",
              quantity: "5 kg",
              message: "Fresh organic tomatoes available"
            }
          ]
        },
        {
          ...
          budget: "500",
          location: "Chittagong",
          description: "Premium quality rice needed",
          created_at: new Date().toISOString(),
          status: "active",
          bids_count: 2
        }
  ...
  if (loading) {
    return (
      <div className="flex h-screen bg-gray-50">
        <ConsumerSidebar activeTab="My Requests" />
