  ...
  const consumerRequests = [
    {
      ...
      isAdminDeal: true,
      description: 'Need fresh, organic tomatoes for my restaurant. Quality must be premium with no bruises or damage.',
    ...
    },
    {
      ...
      isAdminDeal: false,
      description: 'Looking for high-quality basmati rice for wholesale distribution.',
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>{request.pricePerUnit} {request.currency}/{request.unit}</span>
                    </div>
                    
                    <div className="flex items-center text-gray-600">
                      <Calendar className="w-4 h-4 mr-2 text-green-600" />
                      <span>Due: {new Date(request.neededBy).toLocaleDateString()}</span>
                    </div>
